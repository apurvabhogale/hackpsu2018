...
// starts a quiz, they can ask about a specific data element.  
...
{
    let sentence = "The definition of" + item.Term + "is" + item.Definition + "I've added " + item.Term + " to your Alexa app.  Which other software security term would you like to know about?";
    return sentence;
}
...
{
    return "Here is your " + counter + "th question.  What is the " + formatCasing(property) + " of "  + item.Term + "?";
...
{
    return "What is the " + formatCasing(property).toLowerCase() + " of "  + item.Term + "?";
}
...
function getAnswer(property, item)
{
    ...
    {
        case "Abbreviation":
            return "The " + formatCasing(property) + " of " + item.Term + " is <say-as interpret-as='spell-out'>" + item[property] + "</say-as>. ";
        default:
            return "The " + formatCasing(property) + " of " + item.Term + " is " + item[property] + ". ";
    }
}
...
// specific intent.
const WELCOME_MESSAGE = "Welcome to the Software Security Quiz Game!  You can ask me about a software security topic or you can ask me to start a quiz.  What would you like to do?";

// This is the message a user will hear when they start a quiz.
const START_QUIZ_MESSAGE = "OK.  I will ask you 10 questions about the Software Security.";

// This is the message a user will hear when they try to cancel or stop the 
// skill, or when they finish a quiz.
const EXIT_SKILL_MESSAGE = "Thank you for playing the Software Security Quiz Game!  Let's play again soon!";

// This is the message a user will hear when they ask Alexa for help in your 
// skill.
const HELP_MESSAGE = "I know lots of things about Software Security. You can ask me about a software security topic or you can test your knowledge by asking me to start a quiz.  What would you like to do?";
